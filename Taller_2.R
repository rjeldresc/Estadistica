...
setwd("C:/Users/caroh/Documents/RStudio/Modelamiento/Clase 3")
...
summary(Mod2)    #R2 = 0,4599 y p-value: 3.316e-08, significativa
...
#H0: la diferencia o aporte no es significativa
...
plot(M1,4)    #Cook (influyente)  dato 15, 21, 24?
plot(M1,5)    #Leverage    dato 15, 21, 24?
...
lmtest::bptest(M1)   #cumple homocedasticidad
...
# Al aplicar una transformación logarítmica, las diferencias en magnitudes grandes se reducen, 
