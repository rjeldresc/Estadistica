####### REPASO CONTROL 2 #######
setwd("C:/Users/caroh/Documents/RStudio/Clases/Repaso")
...
# p-value = 0.01362 < alpha=5%

t.test(EDAD~EXTRANJERO,alternative="less",var.equal= FALSE)
...
Ex <-base1[EXTRANJERO==1,]
Noex <-base1[EXTRANJERO==0,]
